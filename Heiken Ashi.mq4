...
//---
input color ExtColor1 = Blue;    // Shadow of bear candlestick
...
//--- done
   ...
   GlobalVariableSet("haLowHigh1",ExtLowHighBuffer[rates_total-2]);

   GlobalVariableSet("haOpen2",ExtOpenBuffer[rates_total-3]);
